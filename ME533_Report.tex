...
\onehalfspacing
\begin{center}
\captionof{table}{Material Data for E-Glass Fiber and PBT Polymer} \label{tab:CalculatedValues}
\begin{tabular}{p{2cm} || p{1.5cm} | p{1.5cm} | p{1.5cm} }
\hline
\multicolumn{1}{c|}{Material} & \multicolumn{1}{c|}{Young's Modulus (MPa)} & \multicolumn{1}{c|}{\(\sigma^*\) Fracture Strength (MPa)} & \multicolumn{1}{c}{Shear Modulus} \\
\hline
\hline
...
Using the values in Table \ref{tab:MeasuredValues} the elastic modulus of the samples for short fiber reinforced composites (\(E_{\downarrow \downarrow}^{short}\)) using both the Halpin approach (Equation \ref{eq:halpin}) and simple equation (Equation \ref{eq:simple}).
...
\hline
PBT9 & 13448 & 12529.28 & 7.33 & 107.01 & 99.08 & 8.01 & 0.22\\
PBT11 & 10180.33 & 11141.89 & 8.63 & 111.94 & 91.38 & 22.50 & 0.19\\
PBT12 & 11957 & 8763.61 & 36.44 & 65.31 & 75.28 & 13.25 & 0.14 \\
